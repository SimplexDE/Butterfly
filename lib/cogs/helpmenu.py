...
class buildHelpmenu(menus.ListPageSource):
    ...
    async def format_page(self, menu, entries):
        embed = Embed(title="{} Help".format(self.botname),
...
class Helpmenu(Cog):
    ...
    async def help(self, ctx, cmd: Optional[str]):
        ...
        if cmd:
            ...
            HelpMessage.add_field(name="Basic Information about {}".format(name).capitalize(),
                                  value="> `{}`\n"
                                        "\n"
                                        "> Name: `{}`\n"
                                        "> Usage: `{}`\n"
            ...
            if any([ctx.author.id in self.bot.owner_ids]):
                HelpMessage.add_field(name="Advanced Information about {}".format(name).capitalize(),
                                      value="> Brief: `{}`\n"
                                            "> Hidden: `{}`\n"
                                            "> Cog Name: `{}`\n"
